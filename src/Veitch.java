...
public class Veitch extends JFrame {
	...
	static boolean check8(int row, int col) {
		...
		// Case 2 Bottom to Top Horizontal
				 ...
				 workArray[row][2] == 1 && workArray[row][3] == 1 &&
				 workArray[(4 + (row - 1)) % 4][0] == 1 &&
				 workArray[(4 + (row - 1)) % 4][1] == 1 &&
				 workArray[(4 + (row - 1)) % 4][2] == 1 &&
				 workArray[(4 + (row - 1)) % 4][3] == 1) {
		...
		// Case 3 Left To Right Vertical
				 ...
				 workArray[0][(col + 1) % 4] == 1 &&
				 workArray[1][(col + 1) % 4] == 1 &&
				 workArray[2][(col + 1) % 4] == 1 &&
				 workArray[3][(col + 1) % 4] == 1) {
		...
		else if (workArray[0][col] == 1 &&
				 workArray[1][col] == 1 &&
				 workArray[2][col] == 1 &&
				 workArray[3][col] == 1 &&
				 workArray[0][(4 + (col - 1)) % 4] == 1 &&
				 workArray[1][(4 + (col - 1)) % 4] == 1 &&
				 workArray[2][(4 + (col - 1)) % 4] == 1 &&
				 workArray[3][(4 + (col - 1)) % 4] == 1) {
	...
	static boolean check4(int row, int col) {
		...
		// Case 3 row ++ column ++
		else if (workArray[row][col] == 1 &&
				 workArray[row][(col + 1) % 4] == 1 &&
				 workArray[(row + 1) % 4][col] == 1 &&
				 workArray[(row + 1) % 4][(col + 1) % 4] == 1) {
		...
		// Case 4 row ++ column --
				 ...
				 workArray[row][(4 + (col - 1)) % 4] == 1 &&
				 workArray[(row + 1) % 4][col] == 1 &&
				 workArray[(row + 1) % 4][(4 + (col - 1)) % 4] == 1) {
		...
		else if (workArray[(4 + (row - 1)) % 4][(4 + (col - 1)) % 4] == 1 &&
				 workArray[(4 + (row - 1)) % 4][col] == 1 &&
				 workArray[row][(4 + (col - 1)) % 4] == 1 &&
				 workArray[row][col] == 1) {
		...
		// Case 6 row -- column ++
		else if (workArray[(4 + (row - 1)) % 4][(col + 1) % 4] == 1 &&
				 workArray[(4 + (row - 1)) % 4][col] == 1 &&
				 workArray[row][(col + 1) % 4] == 1 &&
				 workArray[row][col] == 1){
